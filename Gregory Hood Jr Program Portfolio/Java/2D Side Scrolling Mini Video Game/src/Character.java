   ...
   public class Character {
    ...
    //object for character image
      Image still,jump,reverse;
    
    //ammo for character
      static int ammo = 20;
    
      ImageIcon s = new ImageIcon("Jett.png");
      ImageIcon j= new ImageIcon("Jett.png");
      ImageIcon l = new ImageIcon("Jet.png");
    ...
    //default constructor
      ...
      {
         return new Rectangle(left, y,150,69 ) ;
      }
    ...
    //method for character to shoot
      public void fire()
      {
         if (ammo > 0)
         {
            ...
            Bullet z = new Bullet((left + 10), (Board.v + 109/2));
            bullets.add(z);
         }}

   ...
   public class Board extends JPanel implements ActionListener, Runnable  {
      ...
      Character p; 			//variable for character
      ...
      puzzle p1;	//variable for puzzle piece
      ...
      public Board()
      {
         p = new Character();	//create new character object
         addKeyListener(new AL()); //to read keyboard input
      	
         setFocusable(true);
      	
         ImageIcon i = new ImageIcon("sky.jpg");	//background image
         ...
         time.start();
      	...
      	//enemy objects	  
         en = new Enemy2(600, 104, "bird.png");
         en2 = new Enemy2(1000, 50, "bird.png");
         en3 = new Enemy2(1400, 69, "bird.png");
         en4 = new Enemy2(1800, 162, "bird.png");
         en5 = new Enemy2(2200, 171, "bird.png");
         en6 = new Enemy2(2600, 138, "bird.png");
         en7 = new Enemy2(3000, 78, "bird.png");
         en8 = new Enemy2(3400, 165, "bird.png");
         en9 = new Enemy2(3800, 148, "bird.png");
         en10 = new Enemy2(4200, 174, "bird.png");
         en11 = new Enemy2(4600, 50, "bird.png");
         en12 = new Enemy2(5000, 199, "bird.png");
      
         p1 = new puzzle(10000, 195, "puzzle.png");	//puzzle object
      }
      ...
      public void actionPerformed(ActionEvent e) 
      {
         ...
         ArrayList bullets = Character.getBullets(); //ammo for character
      ...
      boolean answer = false;		//variable for puzzle piece detection
   	...
   	//method to check if puzzle piece is collected
      public boolean checkCollisions2()
      {
         //dimensions of objects
         Rectangle r4 = p.getBounds();
         Rectangle r6 = p1.getBounds();
   	...
   	//method to check if enemie is destroyed
      ...
      public void cycle() 
      {
         ...
         if (p.dy == 0) //dy = 0 means up key released of level
         {
            v++;
            
            if (v == 172)	//v is bottom of board
            {
               done = true; //when character is at the bottom of level
            }
         }
         		 
         else
         {
            h = false; //height of level
         	
            if (h == false) //if not at top of level character can keep going
               v--;
         			
            if (v == 0) //if v = 0 character is at top of level
            {
               h = true;
            }
         }
